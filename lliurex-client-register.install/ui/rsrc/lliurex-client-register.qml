...
ApplicationWindow {
    ...
    onClosing:(close)=> {
        ...
        clientRegisterBridge.closeApplication()
        delay(100, function() {
            if (clientRegisterBridge.closeGui){
                closing=true,
                closeTimer.stop(),           
                mainWindow.close();
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle{
                ...
                Image{
                    id:banner
                    source: "/usr/share/lliurex-client-register/rsrc/banner.png"
        ...
        StackView {
            id: mainView
            property int currentIndex:clientRegisterBridge.currentStack
            Layout.minimumWidth:670
